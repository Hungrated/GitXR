...
class RepositoryHeader extends Component {
  ...
  render () {
    ...
    let createStr = repositoryIsFork ? I18n('forked_at') + ' ' +
      repositoryParentName + '\n'
        ...
        <View style={{
          ...
          <View style={[
            styles.flexDirectionRowNotFlex, {
              ...
              borderColor: Constant.lineColor,
