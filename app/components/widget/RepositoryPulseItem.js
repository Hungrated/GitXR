    ...
    return (
      <View style={[
        ...
        <View style={[
          ...
          <View
            style={[
              styles.flexDirectionRow, styles.centered,
              {
                borderColor: Constant.lineColor,
            ...
            <Text
              style={[
                styles.smallText,
                styles.shadowText,
                {marginLeft: 5}]}>{I18n('weekClosed') + closed}</Text>
          </View>
          <View
          ...
          >
            ...
            <Text
              style={[
                styles.smallText,
                styles.shadowText,
                {marginLeft: 5}]}>{I18n('weekOpened') + opened}</Text>
          </View>
        </View>
        <Text
          style={[
            styles.normalText,
            styles.shadowText,
            {marginTop: Constant.normalMarginEdge}]}>{I18n('thisWeek')}</Text>
        <HTMLView
          style={[
            {
              backgroundColor: Constant.transparentColor,
