...
class UserHeadItem extends Component {
  ...
  getActivity (isOrganizations, userDisPlayName) {
    ...
    let item = !isOrganizations ? <View
      style={[
        styles.shadowCard, styles.centered, {
          height: 130,
      ...
      <ScrollView
        ...
        <WebView
          ...
          source={{
            uri: graphicHost + '/' + Constant.primaryColor.replace('#', '') +
              '/' + userDisPlayName
          }}
  ...
  getBottomItem () {
    ...
    return (<View style={[
      styles.flexDirectionRowNotFlex,
      {
        ...
        borderBottomColor: Constant.primaryLightColor
      },
      {
        borderTopWidth: StyleSheet.hairlineWidth,
        borderTopColor: Constant.primaryLightColor
      }
    ]}>
      <NameValueItem
      ...
      <NameValueItem
        ...
        onItemPress={() => {
          Actions.ListPage({
            ...
            showType: 'user',
            currentUser: userDisPlayName,
            title: userDisPlayName + ' - ' + I18n('FollowersText')
          });
        }}/>
      <NameValueItem
        itemStyle={[styles.flex, styles.centered]}
        ...
        onItemPress={() => {
          Actions.ListPage({
            ...
            showType: 'user',
            currentUser: userDisPlayName,
            title: userDisPlayName + ' - ' + I18n('FollowedText')
          });
        }}/>
      <NameValueItem
        itemStyle={[
  ...
  render () {
    ...
    let followView = (needFollow && !isOrganizations) ? <TouchableOpacity
      ...
      <Text
        style={styles.smallTextWhite}>{hadFollowed ? I18n('unFollowed') : I18n(
        'doFollowed')}</Text>
    </TouchableOpacity> : <View/>;

    let Organizations = this.getActivity(isOrganizations, userDisPlayName);

    let menuTitle = !userType ? '' : (userType === 'Organization' ? I18n(
      'Member') : I18n('personDynamic'));
            ...
            <View style={{marginLeft: Constant.normalMarginEdge}}>
              <View style={[styles.centerH, styles.flexDirectionRowNotFlex]}>
                <Text selectable={true} style={[
                  styles.largeTextWhite, {fontWeight: 'bold'},
                  {
                    marginRight: setting
                      ? Constant.normalMarginEdge / 2
                      : 150
                  }]}>
              ...
              <Text selectable={true}
                    style={[styles.subLightSmallText]}>{(userName)
                ? userName
                : hintNum}</Text>
              <IconTextItem
