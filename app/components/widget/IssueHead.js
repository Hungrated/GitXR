    ...
    let stateText = (closed_by) ?
      <View>
        <Text selectable={true}
              style={[
                styles.subSmallText,
                {marginVertical: 5}]}>{'Closed by ' + closed_by.login}</Text>
      </View> : <View/>;
      ...
      <View
        ...
        <View style={[styles.flexDirectionRowNotFlex]}>
          <UserImage uri={actionUserPic}
                     ...
                     style={[
                       {
                         height: Constant.bigIconSize,
                         width: Constant.bigIconSize,
                         marginTop: 5,
          ...
          <View style={{flex: 1, marginLeft: Constant.normalMarginEdge}}>
            ...
            <View
              ...
              <Text style={[styles.miLightSmallText]}
                    selectable={true}>{issueComment}</Text>
            </View>
          </View>
        </View>
        <View style={[
          styles.centerV,
          {marginBottom: issueDes ? Constant.normalMarginEdge : 0}]}>
          <HTMLView
            style={[
              {
