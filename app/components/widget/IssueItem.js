  ...
  render () {
    ...
    let bottom = (this.props.issueTag) ? <View
      ...
      <Icon.Button name="comment"
        ...
        <Text
          style={[styles.subLightSmallText, {fontSize: Constant.minTextSize}]}>
    ...
    /> : <Text selectable={true}
               style={[styles.subSmallText]}>{issueComment}</Text>;
      ...
      <TouchableOpacity
        ...
        <View style={[styles.flexDirectionRowNotFlex]}>
          <UserImage uri={actionUserPic}
                     ...
                     style={[
                       {
                         height: Constant.normalIconSize,
                         width: Constant.normalIconSize,
                         marginTop: 5,
