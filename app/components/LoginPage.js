...
class LoginPage extends Component {
  ...
  componentDidMount () {
    this.onOpen();
    this.handle = BackHandler.addEventListener('hardwareBackPress-LoginPage',
      this.onClose);
  ...
  render () {
    ...
    return (
      <Animated.View
        ...
        <StatusBar hidden={false} backgroundColor={Constant.primaryColor}
                   translucent
        ...
        <View
                  ...
                  padding: Constant.normalMarginEdge
                                ...
                                onPress={() => {
                                  this.setState({
                                    saveUserName: this.params.userName,
                                    savePassword: this.params.password,
                                    secureIcon: (this.state.secureTextEntry)
                                      ? 'eye'
                                      : 'eye-with-line',
                                    secureTextEntry: !this.state.secureTextEntry
                                  });
          ...
          <TouchableOpacity
            ...
            <Text
              style={[styles.subSmallText]}>{' ' + I18n('register') +
            ' '}</Text>
          </TouchableOpacity>
        </View>
      </Animated.View>
