...
import { InteractionManager, Linking, StatusBar, View } from 'react-native';
...
import { generateHtml, getFullName } from '../utils/htmlUtils';
...
class ListPage extends Component {
              ...
              if (rowData.body_html) {
                Actions.CodeDetailPage({
                  ...
                  detail: generateHtml(rowData.body_html,
                    Constant.webDraculaBackgroundColor),
      ...
      case 'notify':
        return (
          <EventItem
            ...
            onPressItem={() => {
              if (rowData.unread) {
                this.props.onItemClickEx &&
                this.props.onItemClickEx(rowData.id);
              }
  ...
  _refresh () {
    switch (this.props.dataType) {
      ...
      case 'followed':
        ...
        break;
      case 'user_repos':
        repositoryActions.getUserRepository(this.props.currentUser, 0,
          this.filterSelect)
          .then((res) => {
            this.setState({
              dataSource: res.data
        ...
        break;
      case 'user_star':
        repositoryActions.getStarRepository(this.props.currentUser, 0,
          this.filterSelect)
          .then((res) => {
            this.setState({
              dataSource: res.data
        ...
        break;
      case 'repo_star':
        repositoryActions.getRepositoryStar(this.props.currentUser,
          this.props.currentRepository, 0)
          .then((res) => {
            this.setState({
              dataSource: res.data
            });
        ...
        break;
      case 'repo_watcher':
        repositoryActions.getRepositoryWatcher(this.props.currentUser,
          this.props.currentRepository, 0)
          .then((res) => {
            this.setState({
              dataSource: res.data
        ...
        break;
      case 'repo_fork':
        repositoryActions.getRepositoryForks(this.props.currentUser,
          this.props.currentRepository, 0)
          .then((res) => {
            this.setState({
              dataSource: res.data
        ...
        break;
      case 'repo_release':
        repositoryActions.getRepositoryRelease(this.props.currentUser,
          this.props.currentRepository, 0).then((res) => {
          this._refreshRes(res);
        });
        break;
      case 'repo_tag':
        repositoryActions.getRepositoryTag(this.props.currentUser,
          this.props.currentRepository, 0).then((res) => {
          this._refreshRes(res);
        });
        break;
      case 'notify':
        userActions.getNotifation(this.props.all, this.props.participating, 0)
          .then((res) => {
            this._refreshRes(res);
          });
        break;
      case 'history':
        ...
        break;
      case 'topics':
        repositoryActions.searchTopicRepository(this.props.topic, 0)
          .then((res) => {
            this._refreshRes(res);
          });
        break;
  ...
  _loadMore () {
    switch (this.props.dataType) {
      case 'follower':
        userActions.getFollowerList(this.props.currentUser, this.page)
          .then((res) => {
            this._loadMoreRes(res);
          });
        break;
      case 'followed':
        userActions.getFollowedList(this.props.currentUser, this.page)
          .then((res) => {
            this._loadMoreRes(res);
          });
        break;
      case 'user_repos':
        repositoryActions.getUserRepository(this.props.currentUser, this.page,
          this.filterSelect).then((res) => {
          this._loadMoreRes(res);
        });
        break;
      case 'user_star':
        repositoryActions.getStarRepository(this.props.currentUser, this.page,
          this.filterSelect).then((res) => {
          this._loadMoreRes(res);
        });
        break;
      case 'repo_star':
        repositoryActions.getRepositoryStar(this.props.currentUser,
          this.props.currentRepository, this.page).then((res) => {
          this._loadMoreRes(res);
        });
        break;
      case 'repo_watcher':
      ...
      case 'repo_tag':
        ...
        break;
      case 'notify':
        userActions.getNotifation(this.props.all, this.props.participating,
          this.page).then((res) => {
          this._loadMoreRes(res);
        });
        break;
      case 'history':
        ...
        break;
      case 'topics':
        repositoryActions.searchTopicRepository(this.props.topic, this.page)
          .then((res) => {
            this._loadMoreRes(res);
          });
        break;
      case 'user_be_stared':
        ...
        break;
      case 'user_orgs':
        userActions.getUserOrgs(this.page, this.props.currentUser)
          .then((res) => {
            this._loadMoreRes(res);
          });
        break;
