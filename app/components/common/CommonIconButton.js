...
class CommonIconButton extends Component {
  ...
  render () {
    ...
    switch (this.local.iconType) {
      case 3:
        icon =
          <Icon3 name={this.local.rightBtn} size={20} color={Constant.miWhite}/>;
        break;
      case 2:
        icon =
          <Icon2 name={this.local.rightBtn} size={20} color={Constant.miWhite}/>;
        break;
      case 1:
      default:
        icon =
          <Icon name={this.local.rightBtn} size={20} color={Constant.miWhite}/>;
        break;
    }
    return (
      <TouchableOpacity
