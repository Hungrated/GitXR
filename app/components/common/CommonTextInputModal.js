...
import styles, { screenHeight, screenWidth } from '../../style/index';
  ...
  getUserList () {
    ...
    return (
      <TouchableOpacity
        ...
        <View style={[
          styles.centered,
          {padding: 40, backgroundColor: '#000000', opacity: 0.8}]}>
          <View style={[
            styles.centered,
            {backgroundColor: Constant.white, borderRadius: 4}]}>
            <ScrollView>
              {items}
            </ScrollView>
          </View>
    ...
    let editTitle = this.props.needEditTitle ? <View style={[
      ...
      <TextInput
        ...
        placeholder={this.props.placeHolderTitle
          ? this.props.placeHolderTitle
          : I18n('issueInputTipTitle')}
    ...
    return (
      <Modal ref={'loginModal'}
        ...
        <View style={[styles.centered, {flex: 1}]}>
          <View style={[
            {borderRadius: 3, backgroundColor: Constant.white},
            styles.centered]}>
            <View style={[
              styles.flexDirectionRowNotFlex,
              {marginTop: 10, paddingBottom: 10},
              {backgroundColor: Constant.white, width: width},
              styles.centered]}>
              <Text
                style={[
                  styles.normalText,
                  {fontWeight: 'bold'}]}>{this.props.titleText}</Text>
            </View>
            {editTitle}
            <View style={[
              {
            ...
            <View
              ...
              <TouchableOpacity
                ...
                <Text
                  style={[styles.subNormalText, {fontWeight: 'bold'}]}>{I18n(
                  'cancel')}</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
                  styles.flex, styles.centerH, {
                    borderLeftWidth: 1,
                ...
                onPress={() => {
                  if (this.text && this.text.trim().length > 0) {
                    ...
                    this.props.textConfirm(this.text, this.title);
                  }
                }}>
                <Text style={[styles.normalText, {fontWeight: 'bold'}]}>{I18n(
                  'ok')}</Text>
              </TouchableOpacity>
            </View>
            {this.getUserList()}
