      ...
      <View style={styles.mainBox}>
        ...
        <ScrollView style={styles.flex}>
          <CommonRowItem
            ...
            textStyle={[
              styles.centered, styles.normalText, {
                textAlignVertical: 'center',
                marginHorizontal: Constant.normalMarginEdge
              }]}
            nameStyle={[
              styles.centered, styles.subNormalText, {
                textAlignVertical: 'center',
                marginHorizontal: Constant.normalMarginEdge
              }]}
            iconSize={20}
          ...
          <CommonRowItem
            ...
            onClickFun={() => {
              this.showEditModal(I18n('infoEmail'), email ? email : '',
                (text) => {
          ...
          <CommonRowItem
            ...
            onClickFun={() => {
              this.showEditModal(I18n('infoCompany'), company ? company : '',
                (text) => {
          ...
          <CommonRowItem
            ...
            onClickFun={() => {
              this.showEditModal(I18n('infoLocation'), location ? location : '',
                (text) => {
